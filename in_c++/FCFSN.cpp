...
// FCFSNoCooperationGateway implementation
FCFSNoCooperationGateway::FCFSNoCooperationGateway(const vector<FogNode>& fog_nodes, const vector<CloudService>& cloud_services)
...
int FCFSNoCooperationGateway::offload_task(Task& task) {
...
void FCFSNoCooperationGateway::print_fog_status() {
...
/*
int main() {
    cout << "=== FCFS No Cooperation Algorithm ===" << endl;
    ...
    // Create gateway
    FCFSNoCooperationGateway gateway(fog_nodes, cloud_services);
    ...
    try {
        ...
        cout << "FCFSNoCooperation: Total = " << fixed << setprecision(2) << avg_processing_time 
             << ", Fog = " << avg_fog_time << ", Cloud = " << avg_cloud_time << endl;
        
        // Power consumption
        cout << "\n=== Power Consumption (W) ===" << endl;
        cout << "FCFSNoCooperation: [";
        ...
        cout << "FCFSNoCooperation: " << fixed << setprecision(2) << avg_queue_delay << endl;
        ...
        cout << "FCFSNoCooperation: Fog = " << fog_count << " (" << fog_percent << "%), Cloud = " 
        ...
        cout << "FCFSNoCooperation: Node = " << fixed << setprecision(4) << avg_node_selection 
