...
// RandomCooperationGateway implementation
RandomCooperationGateway::RandomCooperationGateway(const vector<FogNode>& fog_nodes, const vector<CloudService>& cloud_services)
...
vector<Task> RandomCooperationGateway::get_next_batch(const vector<Task>& all_tasks) {
    // Algorithm 3: Random task selection implementation
    current_batch++;
...
int RandomCooperationGateway::offload_task(Task& task) {
...
void RandomCooperationGateway::print_fog_status() {
...
/*
int main() {
    cout << "=== Random Cooperation Algorithm ===" << endl;
    ...
    // Create gateway
    RandomCooperationGateway gateway(fog_nodes, cloud_services);
    ...
    try {
        ...
        cout << "RandomCooperation: Total = " << fixed << setprecision(2) << avg_processing_time 
             << ", Fog = " << avg_fog_time << ", Cloud = " << avg_cloud_time << endl;
        
        // Power consumption
        cout << "\n=== Power Consumption (W) ===" << endl;
        cout << "RandomCooperation: [";
        ...
        cout << "RandomCooperation: " << fixed << setprecision(2) << avg_queue_delay << endl;
        ...
        cout << "RandomCooperation: Fog = " << fog_count << " (" << fog_percent << "%), Cloud = " 
        ...
        cout << "RandomCooperation: Node = " << fixed << setprecision(4) << avg_node_selection 
